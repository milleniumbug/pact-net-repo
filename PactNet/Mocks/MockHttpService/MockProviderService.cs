...
{
    public class MockProviderServiceOld : IMockProviderService
    {
        ...
        internal MockProviderServiceOld(
        ...
        public MockProviderServiceOld(int port, bool enableSsl, string consumerName, string providerName, PactConfig config, IPAddress ipAddress)
            : this(port, enableSsl, consumerName, providerName, config, ipAddress, null, null, null)
        {
        }

        public MockProviderServiceOld(int port, bool enableSsl, string consumerName, string providerName, PactConfig config, IPAddress ipAddress, Newtonsoft.Json.JsonSerializerSettings jsonSerializerSettings)
            : this(port, enableSsl, consumerName, providerName, config, ipAddress, jsonSerializerSettings, null, null)
        {
        }
        
        public MockProviderServiceOld(int port, bool enableSsl, string consumerName, string providerName, PactConfig config, IPAddress ipAddress, Newtonsoft.Json.JsonSerializerSettings jsonSerializerSettings, string sslCert, string sslKey)
            : this(
