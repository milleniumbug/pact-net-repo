...
namespace PactNet.Tests.Mocks.MockHttpService
{
    public class MockProviderServiceTests
    {
        ...
        private IMockProviderService GetSubject(int port = 1234, bool enableSsl = false)
        {
            ...
            return new MockProviderServiceRust(
                baseUri =>
                {
        ...
        public void Ctor_WhenCalledWithPort_SetsBaseUri()
        {
            ...
            Assert.Equal(expectedBaseUri, ((MockProviderServiceRust)mockService).BaseUri.OriginalString);
        }
        ...
        public void Ctor_WhenCalledWithEnableSslFalse_SetsBaseUriWithHttpScheme()
        {
            ...
            Assert.True(((MockProviderServiceRust)mockService).BaseUri.Scheme.Equals("HTTP", StringComparison.OrdinalIgnoreCase), "BaseUri has a http scheme");
        }
        ...
        public void Ctor_WhenCalledWithEnableSslTrue_SetsBaseUriWithHttpsScheme()
        {
            ...
            Assert.True(((MockProviderServiceRust)mockService).BaseUri.Scheme.Equals("HTTPS", StringComparison.OrdinalIgnoreCase), "BaseUri has a https scheme");
        }
